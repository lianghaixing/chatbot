...
def test():
  with tf.Session() as sess:
    ...
    # Load vocabularies.
    enc_vocab_path = os.path.join(gConfig['data_directory'],"vocab%d.enc" % gConfig['enc_vocab_size'])
    dec_vocab_path = os.path.join(gConfig['data_directory'],"vocab%d.dec" % gConfig['dec_vocab_size'])
